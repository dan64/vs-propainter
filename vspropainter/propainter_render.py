...
class ModelProPainter:
    ...
    def prepare_mask(self, video_frames: list = None, mask_frames: list = None, frame_size: () = None):
        ...
        self.flow_masks, self.masks_dilated = self._read_mask(masks_img_list=img_mask_list, flow_mask_dilates=self.mask_dilation,
    ...
    def model_init(self, torch_device, model_dir: str = None, mpath: str = None):
        ...
        if mpath is None:
            ...
            self.img_mask = Image.open(mpath).convert('RGB')
    ...
    def get_unmasked_frames(self, video_frames: list = None, mask_frames: list = None, batch_size: int = 100, use_half: bool = True,
    ...
    def feature_propagation(self, convert_to_pil: bool = False, out_size: list = None, ref_num: int = -1):
        ...
        if convert_to_pil:
            ...
            np_comp_frames = [cv2.resize(f, self.out_size) for f in comp_frames]
